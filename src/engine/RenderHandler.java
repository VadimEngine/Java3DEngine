...
public class RenderHandler {
    ...
    public void drawTriangleScanLineTex(VertexTex c0, VertexTex c1, VertexTex c2, Texture theTex) {
        ...
        if (pv0.getY() == pv1.getY()) { // natural flat top
            ...
            double alphaSplit = (pv1.getY() - pv0.getY()) / (pv2.getY() - pv0.getY());
            ...
            VertexTex vi = new VertexTex(pv0.getX() + (pv2.getX() - pv0.getX()) * alphaSplit,
                    ...
                    pv0.getTexY() + (pv2.getTexY() - pv0.getTexY()) * alphaSplit, pv0.getTexture());
    ...
    private void drawFlatTopTriangleTex(VertexTex v0, VertexTex v1, VertexTex v2, Texture theTex) {
        ...
        VertexTex dv0 = new VertexTex((v2.getX() - v0.getX()) / delta_y, (v2.getY() - v0.getY()) / delta_y,
                (v2.getZ() - v0.getZ()) / delta_y, (v2.getTexX() - v0.getTexX()) / delta_y,
                (v2.getTexY() - v0.getTexY()) / delta_y);

        VertexTex dv1 = new VertexTex((v2.getX() - v1.getX()) / delta_y, (v2.getY() - v1.getY()) / delta_y,
                (v2.getZ() - v1.getZ()) / delta_y, (v2.getTexX() - v1.getTexX()) / delta_y,
    ...
    private void drawFlatBottomTriangleTex(VertexTex v0, VertexTex v1, VertexTex v2, Texture theTex) {
        double delta_y = v2.getY() - v0.getY();
        VertexTex dv0 = new VertexTex((v1.getX() - v0.getX()) / delta_y, (v1.getY() - v0.getY()) / delta_y,
                (v1.getZ() - v0.getZ()) / delta_y, (v1.getTexX() - v0.getTexX()) / delta_y,
                (v1.getTexY() - v0.getTexY()) / delta_y);

        VertexTex dv1 = new VertexTex((v2.getX() - v0.getX()) / delta_y, (v2.getY() - v0.getY()) / delta_y,
                (v2.getZ() - v0.getZ()) / delta_y, (v2.getTexX() - v0.getTexX()) / delta_y,
                (v2.getTexY() - v0.getTexY()) / delta_y);
    ...
    private void drawFlatTriangleTex(VertexTex v0, VertexTex v1, VertexTex v2, Texture theTex, VertexTex dv0,
            VertexTex dv1, VertexTex itEdge1) {
        ...
        itEdge0.add(new VertexTex(dv0.getX() * ((double) yStart + 0.5f - v0.getY()),
                dv0.getY() * ((double) yStart + 0.5f - v0.getY()), dv0.getZ() * ((double) yStart + 0.5f - v0.getY()),
        ...
        itEdge1.add(new VertexTex(dv1.getX() * ((double) yStart + 0.5f - v0.getY()),
                dv1.getY() * ((double) yStart + 0.5f - v0.getY()), dv1.getZ() * ((double) yStart + 0.5f - v0.getY()),
    ...
    /**
     * x_start = math.max(left.x, 0) and x_end = math.min(rigth.x, screen.width)
     * (same with y)
     * 
     * 
     * @param c1
     ...
     * (same with y)
     * 
     * draw if x_start, x_end, y_start, y_end is within bounds (or x_start <= x_end
     * and y_start <= y_end)
     * 
     * 
     * @param c1
    ...
    /**
     * Custom draw triangle algorithm that iterate a line from c1 to c2 using
     * Bresenham's line algorithm and draws line to c3
     * 
     * @param c1
     * @param c2
     * @param c3
