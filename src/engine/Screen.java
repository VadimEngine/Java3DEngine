...
public class Screen {
    ...
    /**
     * Constructor that initializes cameras and populates all the polygons to
     * render.
     * 
    ...
    /**
     * Sorts the polygons by their distance to the so the closest polygon get
     * rendered last on top of the further polygons and then renders all renderable
     * objects
     * 
