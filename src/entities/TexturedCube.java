...
public class TexturedCube {
	...
	public TexturedCube(double x, double y, double z, double width, double height, double depth, Texture theTexure) {
		...
		// 0,1,2  2,1,3 | 4,5,2  5,2,8 | 2,8,3  8,10,3 | 3,10,6  7,10,6 |  8,9,10  11,9,10 |  9,12,11  12,11,13
		//a 0		f 5		k 10
		//b 1		g 6		l 11
		//c 2		h 7		m 12
		//d 3		i 8		n 13
		//e 4		j 9
		VertexTex ca = new VertexTex(position.getX() + 0,
									 position.getY() + 0,
									 position.getZ() + size,
									 0,0);
		//b
		VertexTex cb = new VertexTex(position.getX() + 0,
									 position.getY() + size,
									 position.getZ() +size,
									 0,1);
		//c
		VertexTex cc = new VertexTex(position.getX() + 0,
									 position.getY() + 0, 
									 position.getZ() + 0,
									 1,0);
		//d
		VertexTex cd = new VertexTex(position.getX() + 0, 
									 position.getY() + size, 
									 position.getZ() + 0,
									 1,1);
		//e
		VertexTex ce = new VertexTex(position.getX() + 0, 
									 position.getY() + 0, 
									 position.getZ() + size,
									 1,-1);
		//f
		VertexTex cf = new VertexTex(position.getX() + size, 
									 position.getY() + 0, 
									 position.getZ() + size,
									 2,-1);
		//g
		VertexTex cg = new VertexTex(position.getX() + 0, 
									 position.getY() + size, 
									 position.getZ() + size,
				                     1,2);
		//h
		VertexTex ch = new VertexTex(position.getX() + size, 
									 position.getY() + size, 
									 position.getZ() + size,
									 2,2);
		//i
		VertexTex ci = new VertexTex(position.getX() + size, 
									 position.getY() + 0, 
									 position.getZ() +0,
									 2,0);
		//j
		VertexTex cj = new VertexTex(position.getX() + size, 
									 position.getY() + 0, 
									 position.getZ() + size,
									 3,0);
		//k
		VertexTex ck = new VertexTex(position.getX() + size, 
									 position.getY() + size, 
									 position.getZ() + 0,
									  2,1);
		//l
		VertexTex cl = new VertexTex(position.getX() + size, 
									 position.getY() + size, 
									 position.getZ() + size,
				  					  3,1);
		//m
		VertexTex cm = new VertexTex(position.getX() + 0, 
									 position.getY() + 0, 
									 position.getZ() + size,
				   					  4,0);
		//n
		VertexTex cn = new VertexTex(position.getX() + 0, 
									 position.getY() + size, 
									 position.getZ() + size,
									  4,1);
